...
var SetUpGuideBtn = cb("📖 SetUp Guide", "guide_1")
...
// GuideBackKeyboard is shown below the SetUp Guide message, letting the user go back.
func GuideBackKeyboard() *gotdbot.ReplyMarkupInlineKeyboard {
	backBtn := cb("« Back", "help_back")
	return &gotdbot.ReplyMarkupInlineKeyboard{
		Rows: [][]gotdbot.InlineKeyboardButton{
			{backBtn, CloseBtn},
		},
