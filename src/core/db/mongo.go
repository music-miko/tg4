...
func InitDatabase() error {
	...
	// Connect the dedicated ArcMusic cache DB (CACHE_DB → arcapi.medias).
	// This is a non-blocking best-effort connection; failures are logged, not fatal.
	go InitArcCacheDB()

	return nil
}

// Close gracefully closes the database connection and the ArcMusic cache DB.
