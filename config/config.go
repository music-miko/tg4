...
var (
	...
	// API_URL / API_KEY  → Arc Music API (YouTube downloads)
	ApiUrl              = getEnv("API_URL", "https://api.arcmusic.fun")
	ApiKey              = os.Getenv("API_KEY")
	// API_URL2 / API_KEY2 → secondary API (Spotify / Apple / SoundCloud / etc.)
	ApiUrl2             = getEnv("API_URL2", "https://api.onegrab.fun")
	ApiKey2             = os.Getenv("API_KEY2")
	// MEDIA_CHANNEL_ID → Telegram channel used as a media cache (direct DB downloading)
