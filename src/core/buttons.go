...
// StartPrivateMarkup returns the keyboard shown in private /start — matches tosu4 style:
// [Add me to Group]  [Setup Guide]
// [Updates]          [Support Chat]
// [Help]
func StartPrivateMarkup(username string) *gotdbot.ReplyMarkupInlineKeyboard {
	addMeBtn := url(
		"➕ Add me to your Group",
		fmt.Sprintf("https://t.me/%s?startgroup=true", username),
	)
	setupBtn := url("⚙️ Setup Guide", config.SupportGroup)
	channelBtn := url("📢 Updates", config.SupportChannel)
